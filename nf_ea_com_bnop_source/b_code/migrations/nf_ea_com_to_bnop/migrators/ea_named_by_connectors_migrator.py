...
from nf_ea_com_bnop_source.b_code.migrations.nf_ea_com_to_bnop.filters.ea_connector_filter import filter_connectors_by_stereotype
...
def migrate_ea_connectors_in_scope_of_naming_pattern(
    ...
    named_by_connectors_with_exemplars = \
        __get_named_by_connectors_with_exemplars(
...
def __get_named_by_connectors_with_exemplars(
    ...
    ea_stereotypes = \
        nf_ea_com_universe.nf_ea_com_registry.dictionary_of_collections[NfEaComCollectionTypes.EA_STEREOTYPES]
    ...
    name_type_instances_connectors_dataframe = \
        filter_connectors_by_stereotype(
            ea_connectors=ea_connectors,
            ea_stereotypes=ea_stereotypes,
            ea_stereotype_usages=ea_stereotype_usages,
    ...
    exemplified_by_instances_connectors_dataframe = \
        filter_connectors_by_stereotype(
            ea_connectors=ea_connectors,
            ea_stereotypes=ea_stereotypes,
            ea_stereotype_usages=ea_stereotype_usages,
    ...
    named_by_name_type_instances_connectors_dataframe = \
        inner_merge_dataframes(
            ...
            merge_suffixes=['_names', '_instances'],
            foreign_key_dataframe=name_type_instances_connectors_dataframe,
            foreign_key_dataframe_fk_columns=[NfEaComColumnTypes.ELEMENTS_CLIENT_PLACE2_END_CONNECTORS.column_name],
            foreign_key_dataframe_other_column_rename_dictionary=
            {
                NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name: NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name + '_instances'
            })

    named_by_name_exemplified_by_instances_connectors_dataframe = \
        inner_merge_dataframes(
            master_dataframe=named_by_name_type_instances_connectors_dataframe,
            master_dataframe_key_columns=[
                NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name + '_instances'],
            merge_suffixes=['', '_exemplified'],
            foreign_key_dataframe=exemplified_by_instances_connectors_dataframe,
            foreign_key_dataframe_fk_columns=[NfEaComColumnTypes.ELEMENTS_CLIENT_PLACE2_END_CONNECTORS.column_name],
            foreign_key_dataframe_other_column_rename_dictionary=
            {
                NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name: NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name + '_exemplified'
            })

    named_by_connectors_with_exemplars_dataframe = \
        inner_merge_dataframes(
            master_dataframe=named_by_name_exemplified_by_instances_connectors_dataframe,
            master_dataframe_key_columns=[
                NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name + '_exemplified'],
            merge_suffixes=['', '_exemplars'],
    ...
    named_by_connectors_with_exemplars_and_uml_names_dataframe = \
        inner_merge_dataframes(
    ...
    named_by_connectors_with_exemplars = \
        named_by_connectors_with_exemplars_and_uml_names_dataframe.to_dict(
            orient='records')
...
def __migrate_named_by_connectors(
        ...
        bnop_repository: BnopRepositories):
    for named_by_connector in named_by_connectors_with_exemplars:
...
def __migrate_named_by_connector(
        ...
        bnop_repository: BnopRepositories):
    named_by_nf_uuid = \
        named_by_connector[NfColumnTypes.NF_UUIDS.column_name]

    named_object_nf_uuid = \
        named_by_connector[NfEaComColumnTypes.ELEMENTS_CLIENT_PLACE2_END_CONNECTORS.column_name]

    named_object_uml_name = \
        named_by_connector[NAMED_OBJECT_UML_NAMES_COLUMN]

    name_nf_uuid = \
        named_by_connector[NfEaComColumnTypes.ELEMENTS_SUPPLIER_PLACE1_END_CONNECTORS.column_name]

    name_uml_name = \
        named_by_connector[NAME_UML_NAMES_COLUMN]

    name_exemplar = \
        named_by_connector[EXEMPLARS_COLUMN]

    if named_object_nf_uuid in BnopObjects.registry_keyed_on_uuid:
        named_object = \
            BnopObjects.registry_keyed_on_uuid[named_object_nf_uuid]
    else:
        named_object = \
    ...
    if name_nf_uuid in BnopObjects.registry_keyed_on_uuid:
        name = \
            BnopObjects.registry_keyed_on_uuid[name_nf_uuid]
    else:
        name = \
            BnopFacades.create_bnop_name(
